...
#### Installing Node.js <a name="installing-nodejs"></a>
...
#### Installing Bun <a name="installing-bun"></a>
...
#### Installing Dependancies <a name="installing-dependancies"></a>
...
#### `.gitignore` & `.gitconfig` <a name="gitignore-gitconfig"></a>
...
#### `.prettierrc.json` & `.prettierignore` <a name="prettierrcjson-prettierignore"></a>
...
#### `astro.config.mjs` <a name="astroconfigmjs"></a>
...
#### `tailwind.config.mjs` <a name="tailwindconfigmjs"></a>
